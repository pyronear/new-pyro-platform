...
interface ImageSettings {
  displayBbox: boolean;
  setDisplayBbox: Dispatch<SetStateAction<boolean>>;
  displayCrop: boolean;
  setDisplayCrop: Dispatch<SetStateAction<boolean>>;
}
...
const AlertImagesActions = ({
  ...
  const { displayBbox, displayCrop, setDisplayBbox, setDisplayCrop } =
    imageSettings;
...
export default AlertImagesActions;
