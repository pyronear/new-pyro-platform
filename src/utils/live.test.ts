...
describe('getMoveToAzimuth', () => {
  it('should return the closest pose to left', () => {
    ...
    expect(result).toEqual({ pose: 0, diffAzimuth: 5, direction: 'Left' });
  });
